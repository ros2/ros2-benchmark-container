...
RUN echo 'alias sweep_executors="${COLCON_SRC_DIR}/ros2_benchmark_container/benchmark/scripts/runners/sweep_executors.sh"' >> ~/.bashrc
RUN echo 'alias compare_runs="python3 ${COLCON_SRC_DIR}/ros2_benchmark_container/benchmark/scripts/post-processing/compare_runs.py"' >> ~/.bashrc
